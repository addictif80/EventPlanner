...
try {
    ...
    // Guarded: the plans/organization_subscriptions tables only exist once
    // migration 005_billing.sql has been applied — older installs that
    // haven't migrated yet must still be able to create an admin.
